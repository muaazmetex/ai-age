...
def save_results(age_results_dict, filename):
    try:
        ...
        for age, result_image in age_results_dict.items():
            ...
            image_path = f"images/{filename}_{age}.jpg"
...
def get_image_paths(base_url, saved_image_paths):
    ...
    try:
        image_paths = [filename for filename in saved_image_paths]
        image_urls = [f'{base_url}{filename}' for filename in image_paths]
